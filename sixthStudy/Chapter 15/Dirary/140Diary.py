...
class MainFrame (wx.Frame):
    def __init__(self):
        ...
        self.MaxImageSize = 200 # 미리보기 이미지의 크기가 가로/세로 최대 200 픽셀을 넘지 않음
        ...
        self.inputTextCtrl = wx.TextCtrl(
            self.leftPanel, size=wx.Size(200, 100), style=wx.TE_MULTILINE) # TE_MUNTILINE : \n을 줄바꿈으로 표시
    ...
    def OnNavigating(self, event):
        ...
        event.Skip(False)   # 해당 URL 이동 하려는것 막음
