...
# 파일 전송 요청에 대한 응답 메시지(0x02)에 사용할 본문 클래스
# 요청 메시지의 MSGID와 수락 여부를 나타내는 RESPONSE 데이터 속성을 가짐
...
# 파일 전송 데이텅의 식별번호 MSGID와 성공 여부를 나타내는 RESULT 데이터 속성을 가짐
